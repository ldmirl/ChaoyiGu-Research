...
for epoch in range(1, n_epochs + 1):
    ...
    if epoch % save_every == 0:
        fn = '/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/model/' + str(epoch) + '.pth'
        torch.save(model.state_dict(), fn)
        print('Saved model to ' + fn)

np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/train_los.npy', np.array(train_los_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/train_kld.npy', np.array(train_kld_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/train_rec.npy', np.array(train_rec_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/test_los.npy', np.array(test_los_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/test_kld.npy', np.array(test_kld_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/test_rec.npy', np.array(test_rec_log))

np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/train_los_batch.npy', np.array(train_los_batch_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/train_kld_batch.npy', np.array(train_kld_batch_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/train_rec_batch.npy', np.array(train_rec_batch_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/test_los_batch.npy', np.array(test_los_batch_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/test_kld_batch.npy', np.array(test_kld_batch_log))
np.save('/home/aarongu/anaconda3/envs/VRNN_Torch/Conditional_VRNN/' + str(model_name) + '/loss/test_rec_batch.npy', np.array(test_rec_batch_log))